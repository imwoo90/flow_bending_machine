...
const ParamData AdditionalStock_ParamDatas[] = {
    {.interval = 25, .x = 80, .y = 100, .font =u8g2_font_logisoso16_tr,},
    {.interval = 0, .x = 80, .y = 100, .font =u8g2_font_logisoso16_tr,},
    {.interval = 0, .x = 80, .y = 100, .font =u8g2_font_logisoso16_tr,},
};
...
const ParamData ColumnTestAll_ParamDatas[] = {
    {.interval = 32, .x = 50, .y = 130, .font = u8g2_font_logisoso16_tr,},
};
const ParamData ColumnTestManul_ParamDatas[] = {
    {.interval = 32, .x = 50, .y = 130, .font = u8g2_font_logisoso16_tr,},
};
const ParamData ColumnTestSection_ParamDatas[] = {
    {.interval = 32, .x = 20, .y = 130, .font = u8g2_font_logisoso16_tr,},
    {.interval = 32, .x = 125, .y = 130, .font = u8g2_font_logisoso16_tr,},
};
...
const ParamData InputMoney_1_ParamDatas[] = {
    {.interval = 32, .x = 100, .y = 60, .font = u8g2_font_logisoso16_tr,},
    {.interval = 32, .x = 100, .y = 100, .font = u8g2_font_logisoso16_tr,},
};
const ParamData ListOfAdditionalStock_ParamDatas[] = {
    ...
    {.interval = 10, .x = 90, .y = 11, .font = u8g2_font_logisoso16_tr,},
    ...
    {.interval = 10, .x = 218, .y = 11, .font = u8g2_font_logisoso16_tr,},
...
const ParamData ManualSales_ParamDatas[] = {
    {.interval = 32, .x = 125, .y = 60, .font = u8g2_font_logisoso16_tr,},
    {.interval = 32, .x = 125, .y = 105, .font = u8g2_font_logisoso16_tr,},
};
const ParamData MatchingChannelAndColumn_ParamDatas[] = {
    {.interval = 32, .x = 10, .y = 120, .font = u8g2_font_logisoso16_tr,},
    {.interval = 32, .x = 125, .y = 120, .font = u8g2_font_logisoso16_tr,},
};
const ParamData MotorTypeSetting_ParamDatas[] = {
    {.interval = 32, .x = 20, .y = 100, .font = u8g2_font_logisoso16_tr,},
    {.interval = 32, .x = 80, .y = 100, .font = u8g2_font_logisoso16_tr,},
    {.interval = 32, .x = 70, .y = 140, .font = u8g2_font_logisoso16_tr,},
};
...
const ParamData SalesInfo_ParamDatas[] = {
    {.interval = 9, .x = 160, .y = 60, .font = u8g2_font_logisoso16_tr,},
    {.interval = 9, .x = 160, .y = 90, .font = u8g2_font_logisoso16_tr, },
    {.interval = 9, .x = 160, .y = 120, .font = u8g2_font_logisoso16_tr,},
    {.interval = 9, .x = 160, .y = 150, .font = u8g2_font_logisoso16_tr,},
};
const ParamData Selling_ParamDatas[] = {
};
const ParamData SetGoods_ParamDatas[] = {
    {.interval = 9, .x = 95, .y = 80, .font = u8g2_font_logisoso16_tr,},
    {.interval = 9, .x = 95, .y = 115, .font = u8g2_font_logisoso16_tr, },
    {.interval = 9, .x = 95, .y = 150, .font = u8g2_font_logisoso16_tr,},
};
